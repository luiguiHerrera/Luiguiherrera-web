...
const phraseMap: Array<[RegExp, string]> = [
  ...
  [/Datos automáticos no disponibles temporalmente\. Mostrando datos demo para mantener la estructura visual\./g, "Automated data temporarily unavailable. Demo data keeps the visual structure active."],
  ...
  [/Actualización diaria con último cierre disponible/g, "Daily update with latest available close"],
