...
const notes = [
  ["La web no recomienda productos", "Las herramientas organizan información educativa y preguntas de análisis. No sugieren compras, ventas ni asignaciones personalizadas."],
  ...
  return (
    <div className="mx-auto max-w-7xl px-5 py-12 md:py-16">
      <SectionHeader
        ...
        title="Metodología"
        subtitle="Esto no es una señal de compra. Es una lectura de contexto."
      />
