    ...
    <div className="mx-auto max-w-7xl px-5 py-12 md:py-16">
      <div className="grid gap-8 lg:grid-cols-[1fr_0.75fr] lg:items-end">
        <SectionHeader
          ...
          title="Quant / TD3 Lab"
          subtitle="Modelos, simulaciones y métricas de riesgo para estudiar portafolios con más método y menos intuición suelta."
        />
        <DisclaimerBox>
      ...
      <section className="mt-10 rounded-lg border border-line bg-panel p-6">
        ...
        <p className="mt-3 max-w-3xl leading-7 text-muted">
          Un espacio para probar modelos experimentales, simulaciones históricas y métricas de riesgo. Los modelos ayudan a ordenar el análisis. No eliminan la incertidumbre.
        </p>
      </section>
          ...
          <table className="w-full min-w-[760px] text-left text-sm">
            <thead className="text-muted">
              <tr className="border-b border-line">
                {["Estrategia", "Retorno anualizado", "Volatilidad", "Máx. drawdown", "Sharpe", "Turnover", "Concentración"].map((header) => (
      ...
      <section className="mt-6 rounded-lg border border-line bg-panel p-6">
        ...
        <div className="mt-5 grid gap-3 md:grid-cols-4">
          {["Integrar resultados reales del modelo TD3", "Añadir universos demo", "Añadir escenarios macro", "Añadir comparación con benchmarks dinámicos"].map((item) => (
