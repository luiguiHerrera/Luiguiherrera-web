...
sys.stderr.write(
    ...
    'docs/regime-engine-v2/sweeper/run-verification.py is a retired historical workspace verifier.\n'
    'No verification, evidence reads, or historical resealing were performed.\n'
    'Original source: git show f5fc7ecfd9e1f323d0ad3a43eccec1dbc500be1c:docs/regime-engine-v2/sweeper/run-verification.py\n'
