...
- Corte de datos automáticos: No aplica
...
- **VOO:** El índice sigue funcional, pero su estabilidad depende de que la correlación permanezca contenida.
- **GLD:** La tesis estructural mejora antes que la técnica: el precio todavía debe confirmar una recuperación.
...
- **Antes / contexto:** El liderazgo de IA y momentum sostenía el índice con concentración elevada.
- **Ahora / cambio:** La rotación interna es extrema y la correlación baja todavía amortigua el agregado.
- **Próximas señales:** Resultados, amplitud y crédito dirán si el ajuste limpia excesos o alcanza al índice.
...
- **Antes / contexto:** GLD acumuló una debilidad técnica prolongada durante julio.
- **Ahora / cambio:** La narrativa estructural mejora, pero el precio todavía no la confirma.
- **Próximas señales:** Tasas reales y recuperación de la media larga serán las señales principales.
...
- **Antes / contexto:** Japón venía mostrando mejor tono relativo dentro de Asia desarrollada.
- **Ahora / cambio:** La corrección de momentum expone concentración y devuelve peso al yen y a las tasas.
- **Próximas señales:** Amplitud de beneficios y estabilidad cambiaria decidirán si conserva el liderazgo.
...
- **Antes / contexto:** FXI mantenía una lectura contrarian por rezago y valoración.
- **Ahora / cambio:** El mercado amplio resiste mejor que los semiconductores, pero aún carece de liderazgo consistente.
- **Próximas señales:** Política, beneficios y flujos deberán confirmar cualquier mejora más duradera.
...
- **Antes / contexto:** La liquidez explicaba buena parte del apetito por cripto.
- **Ahora / cambio:** El mercado vuelve a exigir disciplina frente a dólar y volatilidad tecnológica.
- **Próximas señales:** Flujos y estabilidad de riesgo marcarán la calidad de cualquier rebote.
...
- **Qué esperamos:** Arista Networks, Duolingo y Cloudflare abren ventanas confirmadas entre el 4 y el 6 de agosto. La lectura útil combinará sorpresa, guía y reacción acumulada T+3 a T+5.
...
- **Próximas señales:** La persistencia posterior a resultados distinguirá señal fundamental de ajuste inicial.

### DXY / USD/COP

**La fortaleza del peso está confirmada; su descomposición causal no.**

Clasificación: **rango amplio**
...
- **Antes / contexto:** DXY servía como explicación dominante para buena parte de la variación cambiaria.
- **Ahora / cambio:** El peso se fortaleció más que varios referentes globales y elevó el peso de factores locales.
- **Próximas señales:** Flujos, petróleo y prima soberana dirán si la divergencia persiste o revierte.
...
- **Qué cambiaría:** Moderación de energía rompería la cadena; una nueva aceleración reforzaría la presión.
- **Fecha:** 29 de julio de 2026
- **Fuente:** Federal Reserve Board.
- **Enlace:** [Comunicado oficial de la Fed](https://www.federalreserve.gov/newsevents/pressreleases/monetary20260729a.htm)
...
- **Qué cambiaría:** Convergencia hacia monedas comparables reduciría el componente local; nueva divergencia exigiría una descomposición propia.
- **Fecha:** 1 de agosto de 2026
- **Fuente:** Superintendencia Financiera de Colombia y Banco de la República.
- **Enlace:** [TRM certificada por la SFC](https://www.superfinanciera.gov.co/CargaDriver/index.jsp)
